...
void main(void)
{
    if (gl_InvocationID == 0)
    {
        ...
        {
            //float l0 = length(p2.xy - p0.xy) * 8.0 + 1.0;
            //float l1 = length(p3.xy - p2.xy) * 8.0 + 1.0;
            //float l2 = length(p3.xy - p1.xy) * 8.0 + 1.0;
            //float l3 = length(p1.xy - p0.xy) * 8.0 + 1.0;
